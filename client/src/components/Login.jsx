    ...
    <div onClick={() => setShowLogin(false)}
     ...
     flex items-center text-sm text-gray-600 bg-black/50'>
         ...
         <form
          ...
          p-8 py-12 w-80 sm:w-[352px] text-gray-500 rounded-lg
            ...
            {state === "register" && (
                <div className="w-full">
                    ...
                    <input onChange={(e) =>
                        ...
                        rounded w-full p-2 mt-1 outline-indigo-500"
                        type="text" required />
                </div>
            )}
            <div className="w-full ">
            ...
            {state === "register" ? (
                <p>
                    Already have account? <span onClick={() =>
                        setState("login")} className="text-indigo-500 cursor-pointer">
                            click here</span>
                </p>
            ) : (
                <p>
                    Create an account? <span onClick={() =>
                        setState("register")} className="text-indigo-500 cursor-pointer">
                            click here</span>
                </p>
            )}
